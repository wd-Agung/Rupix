...
export function ImagesPanel({ onCollapse, className }: ImagesPanelProps) {
  ...
  return (
    <div className={cn('flex flex-col h-full bg-white relative', className)}>
      ...
      {/* Coming Soon Overlay */}
      <div className="absolute inset-0 bg-white/5 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="text-center p-8">
          ...
          <p className="text-gray-600 max-w-sm mx-auto">
            We&apos;re working hard to bring you an amazing images experience. Stay tuned!
          </p>
        </div>
      </div>
    </div>
